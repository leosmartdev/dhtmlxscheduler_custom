...
Customized by Leo Sultanov from Russian Federation
    ...
    Scheduler.plugin = function(t) {
        ...
        g.date = {
            ...
            g.clear_event = function(t) {
                ...
                return (d || !1 === t._drag_resize) && (M = "dhx_resize_denied " + M), S += '<div class="' + M + '" style=" width:' + w + "px;" + (d ? " margin-top:-1px;" : "") + f + v + '" ></div>',
                    A.innerHTML = S, A
        ...
        setTimeout(function() {
            var t = ["Your evaluation period for dhtmlxScheduler has expired.", "Please contact us at contact@dhtmlx.com or visit", "https://dhtmlx.com/docs/products/dhtmlxScheduler in order to obtain a license."].join("\n"),
                ...
                n = 24 * i,
                a = 90 * n;
            if ("undefined" != typeof 1634453124000) {
                var r = function() {
                        return Date.now() - 1634453124000 > a
                    },
                    s = function(t, e) {
        ...
        setTimeout(function() {
            var t = [i("0x0", "ueVg"), i("0x1", "5D]O"), i("0x2", "jj7g")][i("0x3", "((gi")](i("0x4", "01pM")),
                ...
                a = 24 * n,
                r = 32 * a;
            if (typeof 1634453124000 !== i("0x5", "T%ZD")) {
                var s = function() {
                        return Date[i("0x6", "0xIg")]() - 1634453124000 > r
                    },
                    o = function(t, e) {
