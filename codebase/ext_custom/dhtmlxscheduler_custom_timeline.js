...
Scheduler.plugin(function(e) {
    e._temp_matrix_scope = function() {
        function t(e, a) {
            if (a = a || [], e.children)
                for (var n = 0; n < e.children.length; n++) a.push(e.children[n].key), t(e.children[n], a);
            return a
        }
        ...
        function i(e) {
            for (var t = {}, a = e.y_unit_original || e.y_unit, i = 0; i < a.length; i++) n(a[i], t);
            return t
        }
        ...
        function r(t, n) {
            ...
            for (var c = n.y_property, _ = 0; _ < t.length; _++) {
                ...
                if (l && f && f.$parent)
                    for (var p = {}; f.$parent;) {
                        if (p[f.key]) throw new Error("Invalid sections tree. Section `{key:'" + f.key + "', label:'" + f.label + "'}` has the same key as one of its parents. Make sure all sections have unique keys");
                        p[f.key] = !0;
                        var m = s[f.$parent];
        ...
        function o() {
            ...
            t.style.position = "absolute", t.style.top = "0px", t.style.left = "0px", t.style.visibility = "hidden", t.style.width = "200px",
                t.style.height = "150px", t.style.overflow = "hidden", t.appendChild(e), document.body.appendChild(t);
            var a = e.offsetWidth;
        ...
        function c(t, a, n, i) {
            function r(e) {
                if (e = e || window.event, !e.shiftKey) {
                    ...
                    t = t < 0 ? -100 : 100, _.scrollTop += t, e.preventDefault && e.preventDefault()
                }
            }
            a._is_ev_creating = !1;
            var _ = d(t, a),
            ...
            if (_.onscroll = function(r) {
                    ...
                    if (a.scrollable && (f.style.top = -h + "px"), !1 !== a.smart_rendering) {
                        if ((u !== a._x_scroll || a._is_ev_creating) && (a.second_scale ? e._timeline_smart_render.updateHeader(a, v, c.children[1]) : e._timeline_smart_render.updateHeader(a, v, c.children[0])), e.config.rtl) {
                            var p = +e.$container.querySelector(".dhx_timeline_label_wrapper").style.height.replace("px", ""),
                                m = a._section_height[a.y_unit.length] + a._label_rows[a._label_rows.length - 1].top;
                            a.scrollHelper.getMode() == a.scrollHelper.modes.minMax && (m > p || "tree" == a.render) ? c.style.right = -1 - u - o() + "px" : c.style.right = -1 - u + "px", c.style.left = "unset"
                        } else c.style.left = -1 - u + "px";
                        (a._options_changed || h !== a._y_scroll || a._is_ev_creating) && e._timeline_smart_render.updateLabels(a, v, f), a._is_ev_creating = !1,
                            e._timeline_smart_render.updateGridCols(a, v), e._timeline_smart_render.updateGridRows(a, v);
                        var y = !1;
                        "cell" != a.render && (window.requestAnimationFrame ? (y = !0, g && cancelAnimationFrame(g), g = requestAnimationFrame(function() {
                            a.name === e.getState().mode && (e._timeline_smart_render.updateEvents(a, v), g = 0, a.callEvent("onScroll", [a.scrollHelper.getScrollValue(_), _.scrollTop]))
            ...
            a.scroll_position && a._is_new_view ? a.scrollTo(a.scroll_position) : e._timeline_set_scroll_pos(t, a),
                a._is_ev_creating = !0
        }
        ...
        function h(e, t) {
            ...
            if (e.matches || e.msMatchesSelector || e.webkitMatchesSelector) {
                ...
                do {
                    if ((a.matches || a.msMatchesSelector || a.webkitMatchesSelector).call(a, t)) return a;
        ...
        function g(t) {
            M && clearInterval(M), e._schedulerOuter = e.$container.querySelector(".dhx_timeline_data_wrapper");
            var a = {
        ...
        function v(t) {
            ...
            if (a) {
                ...
                !c && !l || A || (A = {
                    x: _,
                    y: d
                }, l = 0, c = 0), l *= s.speed_x, c *= s.speed_y, l && c && (Math.abs(l / 5) > Math.abs(c) ? c = 0 : Math.abs(c / 5) > Math.abs(l) && (l = 0)), l || c ? (A.started = !0,
                    p(l, c)) : clearInterval(M)
            }
        }

        function f(e, t, a, n) {
            return e < n && (!A || A.started || e < a) ? -1 : t - e < n && (!A || A.started || e > a) ? 1 : 0
        }
        ...
        e.matrix = {}, e._merge = function(e, t) {
            ...
            function i(t, a, n, i) {
                ...
                return r.$matrix ? (o = r.$matrix[d][l] || [], n && r.$matrix.$tree && r.$matrix.$tree[s.key] && (_ = r.$matrix.$tree[s.key][l] || []),
                    o.concat(_)) : r[d] || []
            }

            function r(t, a, n) {
                for (var i = e.date[n.name + "_start"](new Date(t)), r = 0, o = i, _ = n.x_step, d = n.x_unit; o < a;) r++, o = e.date.add(o, _, d);
                return r
            }
            e._skin_init(), e._merge(a, {
                ...
                }), a._original_x_start = a.x_start, "day" != a.x_unit && (a.first_hour = a.last_hour = 0), a._start_correction = a.first_hour ? 60 * a.first_hour * 60 * 1e3 : 0,
                a._end_correction = a.last_hour ? 60 * (24 - a.last_hour) * 60 * 1e3 : 0, e.checkEvent("onTimelineCreated") && e.callEvent("onTimelineCreated", [a]), dhtmlxEventable(a);
            var _ = e.render_data;
            e.render_data = function(t, n) {
                    if (this._mode != a.name) return _.apply(this, arguments);
                    if (n && !a.show_unassigned && "cell" != a.render)
                        for (var i = 0; i < t.length; i++) this.clear_event(t[i]), this.render_timeline_event.call(this.matrix[this._mode], t[i], !0);
                ...
                e.templates[a.name + "_second_scale_date"] = e.date.date_to_str(a.second_scale && a.second_scale.x_date ? a.second_scale.x_date : e.config.hour_date), e.date["add_" + a.name + "_private"] = function(t, n) {
                    ...
                    if ("minute" == a.x_unit || "hour" == a.x_unit) {
                        ...
                        if (_ * o % 1440)
                            if (+e.date.date_part(new Date(t)) == +e.date.date_part(new Date(r))) a.x_start += n * o;
                            else {
                                var d = 1440 / (o * _) - 1,
                                    s = Math.round(d * o);
                    ...
                    var a = 0;
                    for (var n in this.order) this.order[n] < t && (a += this._section_height[n]);
                    return a
            ...
            e._rendered = [];
            for (var a = t.querySelectorAll("div[event_id]"), n = 0; n < a.length; n++) e._rendered.push(a[n])
            ...
            if (e.config.drag_resize && !e.config.readonly) {
                var f = "dhx_event_resize",
                    p = d + 1,
                    m = "<div class='" + f + " " + f + "_start' style='height: " + p + "px;'></div>",
        ...
        e._timeline_trace_events = function() {
                ...
                var a = "";
                if (t && "cell" != this.render)
                    for (var n = 0; n < t.length; n++) a += e.render_timeline_event.call(this, t[n], !1);
                return a
                ...
                if (t && "cell" != this.render) {
                    ...
                    for (var o = 0; o < t.length; o++) a += e.render_timeline_event.call(this, t[o], !1)
                }
                return a
            }, e._timeline_get_block_stats = function(t, a) {
                var n = {};
                return a._sch_height = t.offsetHeight,
                    n.style_data_wrapper = (e.config.rtl ? "padding-right:" : "padding-left:") + a.dx + "px;", n.style_label_wrapper = "width: " + a.dx + "px;", a.scrollable ? (n.style_data_wrapper += "height:" + (a._sch_height - 1) + "px;", void 0 === a.html_scroll_width && (a.html_scroll_width = o()), a._section_autowidth ? a.custom_scroll_width = 0 : a.custom_scroll_width = a.html_scroll_width, n.style_label_wrapper += "height:" + (a._sch_height - 1 - a.custom_scroll_width) + "px;") : (n.style_data_wrapper += "height:" + (a._sch_height - 1) + "px;",
                        n.style_label_wrapper += "height:" + (a._sch_height - 1) + "px;overflow:visible;"), n
            ...
            e._timeline_get_fit_events_stats = function(e, t, a) {
                ...
                var r = "";
                return i.template && (r += " " + (i.template(i.section, i.view) || "")),
                    "<div class='dhx_timeline_data_row" + r + "' data-section-id='" + y(n) + "' data-section-index='" + e + "' style='" + t.summ_width + t.style_height + " position:absolute; top:" + a + "px;'>"
                ...
                return "<div style='" + t.summ_width + " " + t.style_height + " position:absolute; top:" + a + "px;' data-section-id='" + y(n) + "' data-section-index='" + e + "' class='dhx_matrix_line'>"
            }, e._timeline_get_html_for_bar_data_row = function(e, t) {
                var a = e.table_className;
                return t.template && (a += " " + (t.template(t.section, t.view) || "")), "<div class='dhx_timeline_data_row " + a + "' style='" + e.summ_width + " " + e.style_height + "' >"
            ...
            e._timeline_get_html_for_bar = function(t, a, n, i, r, o) {
                ...
                var v = !1,
                    f = 0,
                    p = null;
                (this.scrollable || this.smart_rendering) && (p = e._timeline_smart_render.getViewPort(this.scrollHelper, this._sch_height)), e._timeline_smart_render._rendered_labels_cache = [], e._timeline_smart_render._rendered_events_cache = [];
                var m, b = !!p;
            ...
            e.attachEvent("onBeforeViewChange", function(t, a, n, i) {
                ...
                for (var i = (this.x_size, t && e._ignores_detected,
                    ...
                    if (this._trace_x[r] = new Date(a), "month" == this.x_unit && e.date[this.x_unit + "_start"] && (a = e.date[this.x_unit + "_start"](new Date(a))), a = e.date.add(a, this.x_step, this.x_unit), e.date[this.x_unit + "_start"] && (a = e.date[this.x_unit + "_start"](a)), e._ignores[r] || i++, r++, t)
                        if (i < this.x_size && !(+a < +n)) n = e.date["add_" + this.name + "_private"](n, (this.x_length || this.x_size) * this.x_step);
                ...
                for (var l = e._min_date_timeline = e._min_date, c = r.displayed, h = r.total, u = 0; u < h; u++) e._ignores[u] ? (e._cols[u] = 0, c++) : e._cols[u] = Math.floor(o / (c - u)), o -= e._cols[u], s[u + 1] = s[u] + e._cols[u];
                if (t.innerHTML = "<div></div>", this.second_scale) {
                    for (var g = this.second_scale.x_unit, v = [this._trace_x[0]], f = [], p = [this.dx, this.dx], m = 0, y = 0; y < this._trace_x.length; y++) {
                        var b = this._trace_x[y];
                        e._timeline_is_new_interval(g, b, v[m]) && (++m, v[m] = b, p[m + 1] = p[m]);
                        var x = m + 1;
                        f[m] = e._cols[y] + (f[m] || 0), p[x] += e._cols[y]
                    }
                    ...
                    for (var D = 0; D < v.length; D++) {
                        var E = v[D],
                            ...
                            N = document.createElement("div");
                        N.className = "dhx_scale_bar dhx_second_scale_bar" + (S ? " " + S : ""), e.set_xy(N, f[D] - 1, n - 3, p[D], 0), N.innerHTML = e.templates[this.name + "_second_scale_date"](E), w.appendChild(N)
                    }
                }
                ...
                for (var M = 0; M < this._trace_x.length; M++)
                    if (!e._ignores[M]) {
                        ...
                        A && (t.lastChild.className += " " + A), t.lastChild.setAttribute("data-col-id", M), t.lastChild.setAttribute("data-col-date", _(l));
            ...
            e._timeline_set_full_view = function(t) {
                ...
                if (a && "DIV" == a.tagName) {
                    if ("dhx_scale_bar" == e._getClassName(a).split(" ")[0]) return {
                ...
                t = t || event;
                for (var a = t.target ? t.target : t.srcElement, n = {}, i = e.matrix[e._mode], r = e.getActionData(t), o = e._ignores, _ = 0, d = 0; d < i._trace_x.length - 1 && !(+r.date < i._trace_x[d + 1]); d++) o[d] || _++;
        ...
        e.dblclick_dhx_marked_timespan = function(t) {
            return e.matrix[e._mode] ? e.dblclick_dhx_matrix_cell(t) : w.apply(this, arguments)
            ...
            if (e.matrix && e.matrix[e._mode]) {
                ...
                if (n) s = [a], d = [n];
                    ...
                    if (l) c.hasOwnProperty(l) && (d.push(l), s.push(o._scales[l]));
                        ...
                        for (var h in c) c.hasOwnProperty(h) && o._scales[h] && (d.push(h), s.push(o._scales[h]))
                }
                var i = i ? new Date(i) : e._min_date,
                    r = r ? new Date(r) : e._max_date;
                if (i.valueOf() < e._min_date.valueOf() && (i = new Date(e._min_date)), r.valueOf() > e._max_date.valueOf() && (r = new Date(e._max_date)), !o._trace_x) return;
                ...
                for (var f = t.zones, p = e._get_css_classes_by_config(t), m = 0; m < d.length; m++) {
                    a = s[m], n = d[m];
        ...
        e._on_scale_add_marker = function(t, a) {
                    ...
                    for (var r = e._mode, o = e._min_date, _ = e._max_date, d = i.global, s = e.date.date_part(new Date(o)); s < _; s = e.date.add(s, 1, "day")) {
                        ...
                        for (var f = 0; f < h.length; f++) {
                            var p = h[f],
                                m = p.days;
                            m < 7 ? (m = l,
                                n.push.apply(n, e._render_marked_timespan(p, t, a, s, e.date.add(s, 1, "day"))), m = c) : n.push.apply(n, e._render_marked_timespan(p, t, a, s, e.date.add(s, 1, "day")))
                        }
                    }
                return n
            }
            ...
            var c;
            if (d >= n._trace_x.length) c = e.date.add(n._trace_x[n._trace_x.length - 1], n.x_step, n.x_unit), n._end_correction && (c = new Date(c - n._end_correction));
            else {
        ...
        e._timeline_smart_render = {
            ...
            _addHeaderCells: function(e, t, a) {
                for (var n = "", i = 0; i < e.length; i++) n += t._h_cols[e[i]].div.outerHTML;
            ...
            getVisibleTimelineRowsHTML: function(t, a, n, i) {
                ...
                return "cell" == t.render ? (r += e._timeline_get_html_for_cell_data_row(i, o, _.top, _.section.key, s), r += this.getVisibleRowCellsHTML(t, a, o, n, i), r += "</div>") : (r += e._timeline_get_html_for_bar_matrix_line(i, o, _.top, _.section.key, s), r += e._timeline_get_html_for_bar_data_row(o, s), r += this.getVisibleRowCellsHTML(t, a, o, n, i), r += "</div></div>"), r
            },
            ...
            _addGridRows: function(t, a, n) {
                ...
                if (i) {
                    for (var r = this.getPreparedEvents(a), o = "", _ = 0; _ < t.length; _++) o += this.getVisibleTimelineRowsHTML(a, n, r, t[_]);
                    i.insertAdjacentHTML("beforeEnd", o);
                    for (var _ = 0; _ < t.length; _++) e._timeline_finalize_section_add(a, a.y_unit[t[_]].key, i);
                    e._mark_now && e._mark_now(), this._rows_to_add = []
                }
            },
            updateGridCols: function(t, a) {
                for (var n = this._rendered_header_cache, i = {}, r = {}, o = 0; o < n.length; o++) r[n[o]] = !0;
                var _ = e.$container.querySelector(".dhx_timeline_data_row");
                if (_)
                    for (var d = _.querySelectorAll("[data-col-id]"), o = 0; o < d.length; o++) i[d[o].getAttribute("data-col-id")] = !0;
                var s = [],
                    l = [];
