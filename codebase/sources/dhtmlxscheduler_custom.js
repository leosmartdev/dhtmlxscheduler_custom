...
scheduler.render_event_bar = function (ev) {
	...
	var _default_bg_color = "#1796b0";
	if (!ev._timed || resizable) {
		cs = "dhx_cal_event_line";
		_default_bg_color = "#0e64a0";
	}
	if(left_chunk){
	...
	var bg_color = (ev.color ? ("background:" + ev.color + ";") : "background: " + _default_bg_color + ";");
	var color = (ev.textColor ? ("color:" + ev.textColor + ";") : "color: #ffffff;");
	// #1796b0
